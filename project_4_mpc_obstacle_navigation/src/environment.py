...
def scenarios() -> list[Scenario]:
    ...
    maps = [
        ...
        Scenario(
            "map_2",
            "staggered corridor with diagonal and vertical crossings",
            np.array([0.0, 0.0, 0.08, 0.0, 0.0], dtype=float),
            np.array([9.0, 6.0], dtype=float),
            (
                CircularObstacle("static_upper_left_gate", np.array([2.75, 4.65]), 0.50, zero),
                CircularObstacle("static_lower_right_gate", np.array([6.25, 1.25]), 0.52, zero),
                CircularObstacle("moving_mid_diagonal", np.array([1.15, 2.05]), 0.32, np.array([0.24, 0.05])),
                CircularObstacle("moving_goal_vertical", np.array([7.55, 3.15]), 0.32, np.array([0.00, 0.07])),
            ),
            base_config,
        ),
        Scenario(
        ...
        Scenario(
            ...
            np.array([9.0, 6.0], dtype=float),
            (
                CircularObstacle("static_lower_pin", np.array([3.55, 1.25]), 0.56, zero),
                CircularObstacle("static_upper_pin", np.array([5.55, 4.85]), 0.58, zero),
                CircularObstacle("moving_corridor_entry", np.array([1.10, 2.65]), 0.35, np.array([0.25, 0.00])),
                CircularObstacle("moving_corridor_exit", np.array([8.40, 3.65]), 0.34, np.array([-0.22, 0.00])),
            ),
            base_config,
        ),
        Scenario(
            "map_5",
            "wide two-crossing passage",
            np.array([0.0, 0.0, 0.08, 0.0, 0.0], dtype=float),
            np.array([9.0, 6.0], dtype=float),
            (
        ...
        Scenario(
            "map_6",
            "open map with two dynamic crossings",
            np.array([0.0, 0.0, 0.08, 0.0, 0.0], dtype=float),
            np.array([9.0, 6.0], dtype=float),
            (
                CircularObstacle("static_upper_open", np.array([3.20, 5.05]), 0.45, zero),
                CircularObstacle("static_lower_open", np.array([6.40, 1.20]), 0.45, zero),
                CircularObstacle("moving_open_entry", np.array([1.05, 2.75]), 0.31, np.array([0.27, 0.00])),
                CircularObstacle("moving_open_exit", np.array([8.40, 4.15]), 0.31, np.array([-0.24, 0.00])),
            ),
            base_config,
        ),
        Scenario(
            "map_7",
            "delayed obstacle near goal",
            np.array([0.0, 0.0, 0.08, 0.0, 0.0], dtype=float),
            np.array([9.0, 6.0], dtype=float),
            (
                CircularObstacle("static_low_early", np.array([3.95, 1.10]), 0.56, zero),
                CircularObstacle("static_high_late", np.array([5.10, 5.45]), 0.58, zero),
                CircularObstacle("moving_delayed_mid", np.array([1.00, 2.65]), 0.34, np.array([0.24, 0.00])),
                CircularObstacle("moving_late_goal", np.array([8.85, 3.75]), 0.34, np.array([-0.20, 0.02])),
            ),
            base_config,
        ),
        Scenario(
            "map_8",
            "dynamic gate with staggered crossings",
            np.array([0.0, 0.0, 0.08, 0.0, 0.0], dtype=float),
            np.array([9.0, 6.0], dtype=float),
            (
                CircularObstacle("static_lower_gate_post", np.array([4.05, 1.25]), 0.52, zero),
                CircularObstacle("static_upper_gate_post", np.array([5.55, 5.15]), 0.52, zero),
                CircularObstacle("moving_gate_sweep", np.array([1.05, 3.05]), 0.33, np.array([0.20, 0.00])),
                CircularObstacle("moving_exit_drop", np.array([7.60, 6.10]), 0.33, np.array([0.00, -0.09])),
            ),
            base_config,
        ),
        Scenario(
            "map_9",
            "central obstacle with route-selection crossing",
            np.array([0.0, 0.0, 0.08, 0.0, 0.0], dtype=float),
            np.array([9.0, 6.0], dtype=float),
            (
                CircularObstacle("static_center_block", np.array([4.75, 3.15]), 0.38, zero),
                CircularObstacle("static_lower_bypass", np.array([6.65, 0.80]), 0.38, zero),
                CircularObstacle("moving_upper_route", np.array([9.30, 4.35]), 0.31, np.array([-0.10, 0.00])),
                CircularObstacle("moving_lower_route", np.array([1.05, 2.05]), 0.31, np.array([0.18, 0.00])),
            ),
            base_config,
        ),
        Scenario(
            "map_10",
            "delayed crossing near final approach",
            np.array([0.0, 0.0, 0.08, 0.0, 0.0], dtype=float),
            np.array([9.0, 6.0], dtype=float),
            (
                CircularObstacle("static_final_shaper", np.array([6.20, 3.55]), 0.45, zero),
                CircularObstacle("static_low_start", np.array([3.35, 1.00]), 0.42, zero),
                CircularObstacle("moving_goal_sweep", np.array([9.50, 4.65]), 0.32, np.array([-0.12, 0.00])),
                CircularObstacle("moving_final_rise", np.array([7.60, 0.80]), 0.31, np.array([0.00, 0.08])),
            ),
            base_config,
        ),
    ]
