...
def scenarios() -> list[Scenario]:
    ...
    maps = [
        ...
        Scenario(
            "map_8",
            "diagonal moving obstacle path",
            np.array([0.0, 0.0, 0.08, 0.0, 0.0], dtype=float),
            np.array([9.0, 6.0], dtype=float),
            (
                CircularObstacle("static_upper_diagonal", np.array([4.00, 4.70]), 0.52, zero),
                CircularObstacle("static_lower_diagonal", np.array([5.90, 1.60]), 0.50, zero),
                CircularObstacle("moving_diagonal_rise", np.array([1.20, 1.80]), 0.31, np.array([0.23, 0.08])),
                CircularObstacle("moving_diagonal_fall", np.array([8.80, 5.80]), 0.32, np.array([-0.08, -0.02])),
            ),
            base_config,
        ),
        Scenario(
            "map_9",
            "offset bottleneck with vertical exit",
            np.array([0.0, 0.0, 0.08, 0.0, 0.0], dtype=float),
            np.array([9.0, 6.0], dtype=float),
            (
                CircularObstacle("static_upper_left_offset", np.array([2.80, 4.55]), 0.48, zero),
                CircularObstacle("static_lower_right_offset", np.array([6.40, 1.35]), 0.50, zero),
                CircularObstacle("moving_offset_cross", np.array([1.15, 2.55]), 0.32, np.array([0.26, 0.00])),
                CircularObstacle("moving_vertical_exit", np.array([7.45, 3.10]), 0.31, np.array([0.00, 0.08])),
            ),
            base_config,
        ),
        Scenario(
            "map_10",
            "late crossing final approach",
            np.array([0.0, 0.0, 0.08, 0.0, 0.0], dtype=float),
            np.array([9.0, 6.0], dtype=float),
            (
                CircularObstacle("static_high_start", np.array([2.80, 4.30]), 0.47, zero),
                CircularObstacle("static_low_goal", np.array([6.50, 1.10]), 0.47, zero),
                CircularObstacle("moving_mid_fast", np.array([1.00, 2.50]), 0.31, np.array([0.26, 0.00])),
                CircularObstacle("moving_goal_drop", np.array([7.00, 6.10]), 0.32, np.array([0.00, -0.09])),
            ),
            base_config,
        ),
    ]
