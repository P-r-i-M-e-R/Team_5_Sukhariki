    ...
    maps = [
        ...
        Scenario(
            ...
            (
                ...
                CircularObstacle("moving_delayed_mid", np.array([1.00, 2.65]), 0.47, np.array([0.24, 0.00])),
                CircularObstacle("moving_delayed_goal", np.array([8.85, 3.75]), 0.34, np.array([-0.20, 0.02])),
            ),
            base_config,
        ),
        Scenario(
