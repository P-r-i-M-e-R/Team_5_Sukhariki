...
1) the adaptation law gives $\dot{\hat{m}}_p = -\alpha Y_p^T s = 0$, so $\tilde{m}_p$ is constant; 
2) substituting $s \equiv 0$ and $\dot{s} \equiv 0$ into the closed-loop equation reduces it to $\tilde{m}_p Y_p = 0$; 
